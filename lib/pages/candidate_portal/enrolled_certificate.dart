...
class _EnrolledCertificateState extends State<EnrolledCertificate> {
  ...
  void openCertificateWebView(BuildContext context, String certificateFileName, String courseName) {
    Navigator.push(
      context,
      MaterialPageRoute(
          ...
          appBar: AppBar(
            ...
            actions: <Widget>[
              IconButton(
                ...
                onPressed: () {
                  shareCertificate(context, certificateFileName, courseName);
                },
              ...
              IconButton(
                ...
                onPressed: () {
                  downloadCertificate(context, certificateFileName, courseName);
                },
  ...
  void shareCertificate(BuildContext context, String certificateUrl, String courseName) {
                ...
                children: [
                  ...
                  if (loaded && earnedCertificate.isNotEmpty)
                    for (CertificateModel certificate in earnedCertificate)
                      GestureDetector(
                        onTap: () {
                          openCertificateWebView(context, certificate.certificate_file_name, certificate.course_name);
                        },
                        child: Container(
...
class _CertificateWebViewState extends State<CertificateWebView> {
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
        WebView(
          initialUrl: "https://docs.google.com/gview?embedded=true&url=${widget.certificateFileName}",
