...
import 'package:skillogic/pages/lms/providers/shared_pref_helper.dart';
import '../constants.dart';
import '../lms_model/course.dart';
import '../lms_model/course_detail.dart';
import '../lms_model/lesson.dart';
import '../lms_model/section.dart';
...
class Courses with ChangeNotifier {
  ...
  List<Course> buildCourseList(List extractedData) {
    ...
    for (var courseData in extractedData) {
      final int? courseId = int.tryParse(courseData['id'].toString());
      if (courseId != null) {
      loadedCourses.add(Course(
        ...
        // rating: courseData['rating'], @utsav 26-04-2024
        rating:5,
        totalNumberRating: int.tryParse(courseData['reviews']),
