...
class LmsHomeScreen extends StatefulWidget {
  static const String routeName = '/lms_home';
  const LmsHomeScreen({Key? key}) : super(key: key);
  @override
      ...
      body: FutureBuilder(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.done) {
            return const TabsScreen(); // Use TabsScreen here
      ...
      child: SingleChildScrollView(
        child: FutureBuilder(
          future:
            ...
            // Provider.of<Courses>(context, listen: false).fetchCoursesByCategory(1),
