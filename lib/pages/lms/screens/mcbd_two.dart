...
class _McbdTwoState extends State<McbdTwo> with SingleTickerProviderStateMixin {
    ...
    FileDownloader().updates.listen((update) async {
      ...
      //     }
        ...
        case TaskProgressUpdate:
          ...
          progressUpdateStream.add(progressUpdate); // pass on to widget for indicator
          break;
      }
    });
  }
  ...
  /// Callback function for task progress updates utsav
  void myTaskProgressCallback(TaskProgressUpdate progressUpdate) {
    // Extract task and progress from progressUpdate
