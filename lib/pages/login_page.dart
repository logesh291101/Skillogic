...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<void> _loginService(var email, var password) async {
      ...
      //var finalUrl = "https://f18xa7ot97.execute-api.us-east-1.amazonaws.com/login";
      var finalUrl = "${authUrl}login";
      log("auth_url--${prefs.getString("auth_url")}");
      log("auth_url_tm--${prefs.getString("auth_url_tm")}");
          log("base_url--${prefs.getString("base_url")}");
          log("candidate_portal_url--${prefs.getString("candidate_portal_url")}");
      ...
      map['paswrd'] = password;
        ...
        if (response.statusCode == 200) {
          ...
          // await prefs.setString("userSession", resp["user_data"]['current_active_session_id']??"");
          // await prefs.reload();
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      //   color: Colors.white,
                      //   onPressed: () {
                      //    VerifyOtp(email: "logeshlogesh9205@gmail.com");
                      //   },
                      //   child: SizedBox(
                      //     height: 48,
                      //     child: Center(
